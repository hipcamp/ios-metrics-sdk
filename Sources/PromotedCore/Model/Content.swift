...
public class Content: NSObject {
  ...
  @objc public var properties: Message?
  ...
  public init(
    ...
    properties: Message? = nil // TODO: what should this be?
  ) {
    self.name = name
  ...
  @objc public init(
    ...
    self.properties = properties?.firstValueFromKeysInArray(customPropertiesKeys)
  }
}
...
public extension Content {
  ...
  override var debugDescription: String {
    ...
    if let properties = self.properties {
      result += "\(separator)properties=\(properties)"
    }
    result += ")"
    return result
  }
